            ...
            public void onActivityResult(ActivityResult o) {
                if (o.getResultCode()==RESULT_OK){
                    ...
                    if (intentFromResult!=null){
                        ...
                        //binding.imageView.setImageURI(imageData); bu işimize yaram çünkü bitmape falan çevirip veritabanına da ekleyeceğiz;
                        try {
                            ...
                            }else { //getContentResolver() == ArtActivity.this.getContentResolver()
